...
- [Points, lines, and planes - In what follows are various notes and algorithms dealing with points, lines, and planes.](http://paulbourke.net/geometry/pointlineplane/)
- [Finding a linear equation Ax + By + C = 0 given 2 points](https://bobobobo.wordpress.com/2008/01/07/solving-linear-equations-ax-by-c-0/)
...
- [Singular Value Decomposition (SVD) Visualisation](https://alyssaq.github.io/2015/singular-value-decomposition-visualisation/)
- [Lecture 9. Linear Least Squares. Using SVD Decomposition.](http://www.math.uconn.edu/~leykekhman/courses/MATH3795/Lectures/Lecture_9_Linear_least_squares_SVD.pdf)
- [The Singular Value Decomposition - Prof. Walter Gander - ETH Zurich - Decenber 12, 2008](https://www2.math.ethz.ch/education/bachelor/lectures/hs2014/other/linalg_INFK/svdneu.pdf)
- [Least Squares using the SVD - Demo - Ipynb](https://andreask.cs.illinois.edu/cs357-s15/public/demos/09-svd-applications/Least%20Squares%20using%20the%20SVD.html)
- [Robotics - Pose estimation - Coursera](https://www.coursera.org/lecture/robotics-perception/where-am-i-part-1-q9CXI)

## Hough transform
- [[Hough transform] Line detection (Cartesian, Polar and Space reduction)](http://laid.delanover.com/hough-transform-line-detection-cartesian-polar-and-space-reduction/)
- [E0005E - Industrial Image Analysis - The Hough Transform - Matthew Thurley](https://www.ltu.se/cms_fs/1.36192!/e0005e_lecture05_hough_transform.dvi.pdf)
